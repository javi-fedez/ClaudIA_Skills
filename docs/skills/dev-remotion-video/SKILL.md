---
name: dev-remotion-video
description: Diseña, escribe y renderiza vídeos programáticos con Remotion (React/TypeScript), con búsqueda semántica en la documentación oficial vía MCP. Úsalo para crear vídeos generados por código.
---
