---
name: dev-scripts-catalog
description: Inventario de referencia de los scripts Python del proyecto y cómo invocarlos. NO es una skill ejecutable — sirve como catálogo rápido. Úsalo para saber qué scripts existen.
---
