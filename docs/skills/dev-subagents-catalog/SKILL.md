---
name: dev-subagents-catalog
description: Inventario de referencia de los sub-agentes disponibles y cuándo delegarles trabajo. NO es una skill ejecutable — sirve como catálogo. Úsalo para decidir a qué agente delegar.
---
