---
name: infra-hooks-and-logging
description: Documentación del sistema de hooks de Claude Code que registra toda interacción y el cierre de sesión a un log JSONL. Referencia de infraestructura. Úsalo para entender o gestionar el logging.
---
