...
Investiga y prioriza palabras clave para un tema dado, adaptadas al perfil de Marca C y sus dos sitios web (marca-c.example.com y marca-a.example.com).
...
Antes de cualquier búsqueda, leer `docs/marca-c.md` y extraer:
- Temas pillar relevantes para el tema dado
- ICP (público objetivo) para orientar la intención de búsqueda
- Sitio destino: ¿marca-c.example.com (PYMEs genérico) o marca-a.example.com (Copilot/adopción IA)?
...
- ¿Es para **marca-c.example.com** (blog general de IA para PYMEs) o **marca-a.example.com** (Copilot 365 y adopción IA)?
...
Buscar también:
- `site:marca-c.example.com [tema]` — evitar duplicar contenido existente
- `site:marca-a.example.com [tema]` — idem
...
**Sitio destino**: marca-c.example.com / marca-a.example.com
...
## Notas
- Priorizar keywords con intención comercial para marca-a.example.com (más cerca de la conversión)
- Priorizar keywords informacionales para marca-c.example.com (captación de audiencia y newsletter)
