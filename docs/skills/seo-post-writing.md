...
Redacta un post de blog completamente optimizado para SEO a partir de un brief, usando la voz y estilo de Marca C.
...
Leer `docs/marca-c.md` y extraer antes de escribir:
...
- Sitio destino — marca-c.example.com o marca-a.example.com
...
1. ¿Para qué sitio? (marca-c.example.com o marca-a.example.com)
2. ¿Keyword principal?
...
- Datos y cifras siempre que refuercen el argumento (usar los de `marca-c.md` sección 12 si aplican)
...
- CTA claro y directo usando uno de los habituales de Javi:
  - Para marca-c.example.com: suscripción al blog / newsletter
  - Para marca-a.example.com: "Solicita tu diagnóstico inicial gratuito" / "Escríbeme a hola@marca-a.example.com"
...
- No inventar estadísticas — usar datos reales de `marca-c.md` o buscarlos con WebSearch
- El ángulo diferencial de Javi: siempre anclar el contenido en la experiencia real formando empresas
- Para marca-a.example.com: el tono puede ser ligeramente más corporativo pero sin perder cercanía
