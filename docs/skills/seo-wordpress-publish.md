...
1. Leer `docs/marca-c.md` sección 14 para obtener las URLs de la API
2. Las credenciales van en `.env` — NUNCA en este archivo:
   ```
   WP_JF_URL=https://marca-c.example.com
   WP_JF_USER=tu_usuario
   WP_JF_PASSWORD=tu_application_password   # WP Application Password
   WP_AU_URL=https://marca-a.example.com
...
- ¿Publicar en **marca-c.example.com** o **marca-a.example.com**?
