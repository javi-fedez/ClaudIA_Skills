---
name: supabase
description: Gestiona todos los proyectos Supabase del usuario (Postgres, Auth, Storage, Edge Functions, Realtime) vía el MCP oficial. Úsalo para operar Supabase. Confirma siempre el project_ref antes de cambios destructivos.
---
